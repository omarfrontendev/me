  ...
  const projects = [
    {
      ...
      type: "React",
      github: "https://github.com/omarfrontendev/emze",
      demo: "https://omarfrontendev.github.io/emze/",
    },
    {
      title: "We Can",
      // img: "http://localhost:3000/static/media/34.1ba2d83da3a8b3d09bc1.png",
      type: "React",
      github: "https://github.com/omarfrontendev/we-can",
      demo: "https://omarfrontendev.github.io/we-can/",
    },
    {
      title: "shubz",
      // img: "http://localhost:3000/static/media/34.1ba2d83da3a8b3d09bc1.png",
      type: "React",
      github: "https://github.com/omarfrontendev/shubz-web",
      demo: "https://omarfrontendev.github.io/shubz/",
    },
    {
      title: "Project Next.js",
      // img: "http://localhost:3000/static/media/34.1ba2d83da3a8b3d09bc1.png",
      type: "React",
      github: "https://github.com/omarfrontendev/landingpage",
      demo: "https://landingpage-tawny.vercel.app/",
    },
    {
      title: "Dashoard",
      // img: "http://localhost:3000/static/media/34.1ba2d83da3a8b3d09bc1.png",
    ...
    },
    {
      ...
      type: "React",
      github: "http://localhost:3000/static/media/5.943cc0259a23181a95c9.png",
  ...
  return (
    <section>
      ...
      <ul className="btns-container">
        <li>
          <button onClick={() => setCurrentProject(projects)}>All</button>
        </li>
        <li>
          <button
            onClick={() =>
              setCurrentProject(projects.filter((p) => p.type === "React"))
            }
          >
            React
          </button>
        ...
        <li>
          <button
            onClick={() =>
              setCurrentProject(projects.filter((p) => p.type === "Bootstrap"))
            }
          >
            Bootstrap
          </button>
        ...
        <li>
          <button
            onClick={() =>
              setCurrentProject(projects.filter((p) => p.type === "JS"))
            }
          >
            Js
          </button>
        ...
        <li>
          <button
            onClick={() =>
              setCurrentProject(projects.filter((p) => p.type === "Css"))
            }
          >
            Css
          </button>
        ...
        {currentProject.map((project, i) => (
          <article key={i}>
            <div className="portf_img">
              <img src={images[i]} alt="project__IMG" />
            </div>
            <h3>
